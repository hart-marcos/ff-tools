...
$old_json = file_get_contents("links/" . $type . ".json");

$link_nbr = count((array)json_decode($old_json));
...
if($n != 1){
  ...
  $final_urls = array_merge($new_urls, $array_old);  
}else{
  $final_urls =  $new_urls; 
}
...
echo $name . " --> " . $ok . "<br><br> limit --> " . $limit;
